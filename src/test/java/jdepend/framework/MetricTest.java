...
public class MetricTest extends JDependTestCase {
    ...
    private void assertAnalyzePackages() {
        ...
        assertEquals(22, jdepend.countClasses());
    ...
    private void assertFrameworkPackage() {
        ...
        assertEquals(10, p.getConcreteClassCount());
        assertEquals(2, p.getAbstractClassCount());
        assertEquals(3, p.afferentCoupling());
        assertEquals(0, p.efferentCoupling());
        assertEquals(format(0.17f), format(p.abstractness()));
        assertEquals(format(0f), format(p.instability()));
        assertEquals(format(0.83f), format(p.distance()));
